...
model_path = "/Users/zhoubingzheng/projects/huggingface/dreambooth-base-model"
pipe = StableDiffusionPipeline.from_pretrained(model_path, torch_dtype=torch.float16).to("mps")

prompt = "a photo of fashion man walking on the street, BMW, tall buildings, summary, highly detailed, 4k"
image = pipe(prompt=prompt, num_inference_steps=50, guidance_scale=7.5).images[0]
image.save("./examples/dreambooth/images/dreambooth.png")
